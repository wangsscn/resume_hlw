...
\begin{tabular*}{\textwidth}{l@{\extracolsep{\fill}} r}
  \textbf{\href{https://wangsscn.github.io/resume_hlw/}{\Large Hsiao-Lun Wang}} & Email: \href{mailto:hsiaolunwang256@gmail.com}{hsiaolunwang256@gmail.com}\\
  \href{https://www.linkedin.com/in/hsiao-lun-wang} {LinkedIn}  \href{https://github.com/wangsscn} {GitHub}  & Mobile: \href{tel:+32 0492-80-22-82}{+32 492 80 22 82} \\
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Postdoc Researcher/ R\&D Engineer}{Feb 2022 - Present}
      {imec - 3D Silicon Photonics - PathFindingDevice}{Leuven, Belgium}
      {Hybrid Integrated Lasers with Silicon Photonics}{}
      \resumeItemListStart
        \resumeItem{Photonic simulations}
          {-- Optical coupling simulations using 3D FDTD;}
          {-- MODE to design SiN DBR}
        
        \resumeItem{PIC Layout and tapeout}
          {-- Using IPKISS and imec PDK to layout and tapeout integrated lasers plus DoE test sites}
        \resumeItem{Laser Modeling and data analysis}
          {-- Develop DBR external cavity laser model in python}
...
\section{Engineer Skills}
  \resumeSubHeadingListStart
    ...
    %   {python and Matlab to solve laser rate equations}
